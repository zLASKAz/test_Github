...
import CheckCircleIcon from "@mui/icons-material/CheckCircle";
  function DashboardDistrict() {
    ...
    const data = [
      { name: "นนทบุรี, เมืองนนทบุรี", uv: 680, pv: 750, amt: 2400 },
      { name: "นนทบุรี, บางกรวย", uv: 270, pv: 0, amt: 2400 },
      { name: "นนทบุรี, บางใหญ่", uv: 520, pv: 330, amt: 2400 },
      { name: "นนทบุรี, บางบัวทอง", uv: 400, pv: 440, amt: 2400 },
      { name: "นราธิวาส, เมืองนราธิวาส", uv: 400, pv: 222, amt: 2400 },
      { name: "นราธิวาส, ระแงะ", uv: 333, pv: 1000, amt: 2400 },
      { name: "นราธิวาส, ตากใบ", uv: 400, pv: 444, amt: 2400 },
      { name: "นราธิวาส, จะแนะ", uv: 888, pv: 555, amt: 2400 },
      { name: "นราธิวาส, บาเจาะ", uv: 400, pv: 777, amt: 2400 },
      { name: "นราธิวาส, ยี่งอ", uv: 680, pv: 750, amt: 0 },
        ...
        <div className="container-2-Dashboard">
          <div className="box box4">
            <div style={{ padding: "0 40px" }}>
              ...
              <p style={{color:"#1150A4"}}>| จำนวนจังหวัดที่เข้าเกณฑ์เปิด EOC <span style={{color:"#CE6D4A"}}>| จำนวนจังหวัดที่เปิด EOC</span></p>
              <br></br>
          ...
          <div className="box box5">
            <div style={{ display: "flex" ,justifyContent:"space-between"}}>
              ...
              <div
                  style={{ border: "1px solid #1150A4",width:"150px",height:"100px",marginRight:"20px"}}
                  className="ColorDashboardEOC-1"
                >
                  <div style={{padding:'10px',display:"flex",flexDirection:"column"}}>
                    <div><p style={{ margin: "0",justifyContent:"flex-end" ,display:"flex"}}> เข้าเกณฑ์เปิด EOC </p></div>
                    <h1
                      style={{
                        marginTop: "0",
                ...
                <div
                  style={{ border: "1px solid #CE6D4A",width:"150px",height:"100px"}}
                  className="ColorDashboardEOC-2"
                >
                  <div style={{padding:'10px',display:"flex",flexDirection:"column"}}>
                    <div><p style={{ margin: "0",justifyContent:"flex-end" ,display:"flex"}}> เปิด EOC </p></div>
                    <h1
                      style={{
                        marginTop: "0",
                        justifyContent: "flex-end",

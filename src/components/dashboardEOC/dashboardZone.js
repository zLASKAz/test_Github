...
function DashboardZone() {
  ...
  const data = [
    { name: "สคร. 1", uv: 680, pv: 750, amt: 0 },
    { name: "สคร. 2", uv: 270, pv: 0, amt: 2400 },
    { name: "สคร. 3", uv: 520, pv: 330, amt: 2400 },
    { name: "สคร. 4", uv: 400, pv: 440, amt: 2400 },
    { name: "สคร. 5", uv: 400, pv: 222, amt: 2400 },
    { name: "สคร. 6", uv: 333, pv: 1000, amt: 2400 },
    { name: "สคร. 7", uv: 400, pv: 444, amt: 2400 },
    { name: "สคร. 8", uv: 888, pv: 555, amt: 2400 },
    { name: "สคร. 9", uv: 400, pv: 777, amt: 2400 },
    { name: "สคร. 10", uv: 680, pv: 750, amt: 0 },
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <div>
              <FormControl sx={{ m: 3, minWidth: 200 }} size="small">
                ...
                >
                  <MenuItem value={10}>{datadata.info}</MenuItem>
                </Select>
              </FormControl>
            </div>
            ...
            <div style={{display:"flex",flexDirection:"column"}}>
              ...
              <div>
                    <TableContainer component={Paper} sx={{width:"95%" , margin:"20px auto"}}>
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            <TableCell><b>เขต</b></TableCell>
            <TableCell align="center"><b>เข้าเกณฑ์เปิด EOC</b></TableCell>
            <TableCell align="center"><b>เปิด EOC</b></TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {datadata.map((row) => (
            ...
            >
              ...
              <CheckCircleIcon fontSize="small" sx={{ color: "#1150A4" }}  onClick={handleClick}/>
              </TableCell>
              <TableCell align="center">
              <CheckCircleIcon fontSize="small" sx={{ color: "#B4B4B4" }} onClick={handleClick}/>
              </TableCell>
